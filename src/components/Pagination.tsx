...
export const Pagination = ({
    ...
    const lastPage = paginationRange?.length && paginationRange[paginationRange.length - 1];
    ...
    return (
        <Container>
            <ButtonContainer onClick={onPrevious}>
                <FontAwesomeIcon icon={faArrowLeft} color={currentPage === 1 ? 'gray' : 'white'} />
            </ButtonContainer>
            <TextContainer>{`Page ${currentPage} of ${lastPage}`}</TextContainer>
